# gatet4.py - Gateway 4 Stripe Checker
...
def Tele(ccx: str, amount: str = "1.00"):
    """
    Check credit card via Stripe Gateway 4
    ...
    if len(parts) != 4:
        return "ERROR: Invalid format", "Gate 4"
...
if __name__ == "__main__":
    ...
    result, gateway = Tele(test_card, "1.00")
