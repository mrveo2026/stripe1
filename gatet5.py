# gatet5.py - HBCU Sports Stripe Gateway (Medium-High Amount)
...
def Tele(ccx: str, amount: str = "1.60"):
    """
    Check credit card via hbcusports.com
    ...
    parts = ccx.split("|")
    if len(parts) != 4:
        return "ERROR: Invalid format", f"Gate 5 ${amount}"
...
if __name__ == "__main__":
    print("=" * 60)
    print("Gate 5 - HBCU Sports Stripe Checker")
    print("=" * 60)
